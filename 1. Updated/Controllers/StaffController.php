...
class StaffController extends Controller
{
    ...
    public function customLogin(Request $request)
    {
        ...
        $credentials = $request->only('email', 'password');
         if (Auth::guard('staff')->attempt($credentials)) {
            return redirect()->intended('staffDashboard')->withSuccess('Signed in');  //index
        }
    ...
    {  
        ...
        if ($users === null) {
            ...
            $data = $request->all();
            $this->create($data);
            return redirect('staffDashboard')->withSuccess('You have signed-in'); //index
        } else {
            // User exits
