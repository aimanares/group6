...
//Route::resource('riderMain', OrderController::class);

//Route::resource('riderMain', 'App\Http\Controllers\orderController');
...
Route::get('team', 'App\Http\Controllers\CustomerController@team');
Route::get('services', 'App\Http\Controllers\CustomerController@services'); 
Route::get( 'Foodfile\CustomerController@services');

//Route::get('staffMain', [StaffController::class, 'staffIndex']);